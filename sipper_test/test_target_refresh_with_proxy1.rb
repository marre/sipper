...
class TestTargetRefreshWithProxy1 < DrivenSipTestCase
  ...
  def setup
    ...
    module SipInline
      class UasRt1Controller < SIP::SipTestDriverController
        ...
        def on_success_res(session)
          ...
          session.flow_completed_for("TestTargetRefreshWithProxy1")
        end
      ...
      class UacRt1Controller < SIP::SipTestDriverController
    ...
    set_controller("SipInline::UacRt1Controller")
  end
  ...
  def test_rt1_controllers
    ...
    self.expected_flow = ["< INVITE", "> 100", "! double_via", "> 200", "< ACK", "! single_via", "> BYE", "< 200"]
    verify_call_flow(:in)
  end
