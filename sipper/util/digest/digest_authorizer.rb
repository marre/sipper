...
module SipperUtil
  class DigestAuthorizer
    ...
    def create_authorization_header(c, proxy, u, p, lsr)
      ...
      atn_hdr.qop = @c.qop 
      atn_hdr.cnonce = SipperUtil.quote_str @cnonce 
    ...
    # :qop
    def create_authentication_header(realm, domain, add_opaque=false, stale=false, proxy=false)
      if proxy
    ...
    def do_authentication(req, u, p)
      ...
      @p = p
      @lsr = req
      @cnonce = SipperUtil.unquote_str atn_hdr.cnonce
